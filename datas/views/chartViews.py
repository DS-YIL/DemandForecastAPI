...
from ..utils.code_break_explosion import code_break_explosion
    ...
    def post(self, request, format=None):
        ...
        try:
            ...
            for i in range(len(code)):
                d1 = code_break_explosion(code[i], model_qty[i])  # calling main bom explosion
